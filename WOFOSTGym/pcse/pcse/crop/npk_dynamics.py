...
class NPK_Crop_Dynamics(SimulationObject):
    ...
    **External dependencies**
    ...
    def _check_N_balance(self, day: date) -> None:
    ...
    def _check_P_balance(self, day: date) -> None:
    ...
    def _check_K_balance(self, day: date) -> None:
    ...
    def reset(self) -> None:
        ...
        r.RNAMOUNTLV = r.RPAMOUNTLV = r.RKAMOUNTLV = r.RNAMOUNTST = r.RPAMOUNTST = r.RKAMOUNTST = r.RNAMOUNTRT = (
            r.RPAMOUNTRT
        ) = r.RKAMOUNTRT = r.RNAMOUNTSO = r.RPAMOUNTSO = r.RKAMOUNTSO = r.RNDEATHLV = r.RNDEATHST = r.RNDEATHRT = (
            r.RPDEATHLV
        ) = r.RPDEATHST = r.RPDEATHRT = r.RKDEATHLV = r.RKDEATHST = r.RKDEATHRT = r.RNLOSS = r.RPLOSS = r.RKLOSS = 0
