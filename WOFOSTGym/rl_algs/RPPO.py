...
Docs: https://github.com/vwxyzjn/cleanrl/blob/master/cleanrl/ppo_atari_lstm.py
...
def train(kwargs: Namespace) -> None:
    ...
    args = kwargs.alg
    print(f"Entering RPPO Training for {args.total_timesteps} timesteps ({args.num_iterations} iterations)...\n")
